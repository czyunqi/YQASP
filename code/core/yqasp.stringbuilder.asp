<%
'######################################################################
'## YQasp.stringbuilder.asp
'## -------------------------------------------------------------------
'## Feature     :   YQAsp StringBuilder Class
'## Version     :   1.0
...
Class YQAsp_Str_StringBuilder
  ...
  Private Sub AppendString(ByVal string, ByVal newLine, ByVal format)
    ...
    End If
    If b_format Then
      a_sb(i_index) = YQasp.Str.Format(string, format)
    Else
      a_sb(i_index) = string
    End If
    i_index = i_index + 1
  ...
  Private Sub InsertString(ByVal string, ByVal newLine, ByVal format)
    ...
    End If
    If b_format Then
      a_sbi(i_indexi) = YQasp.Str.Format(string, format)
    Else
