...
Class YQAsp_Encrypt
  ...
  Private Sub Class_Initialize()
    s_seed = "YQAsp_encrypt_seed_by_coldstone"
    s_key = ""
  End Sub
  ...
  Public Function EncryptBy(ByVal string, ByVal s_key)
    ...
    Dim p1, s1, s2
    If YQasp.IsN(string) Then Exit Function
    ...
    For i = 1 To i_times
      For j = 1 To i_keyleng
        ...
        'YQasp.Console i_re & " = " & i_str & " + " & i_key  & " + 42769"
        'YQasp.Console n2s(i_re, 43, 39)
    ...
    For i = 1 To i_leng
      ...
      Else
        s2 = s2 & s1
      End If
      'If Len(s2) = 6 Then YQasp.Console s2 & " == " & n2s(s2, 94, 33)
  ...
  Public Function DecryptBy(ByVal string, ByVal s_key)
    ...
    For i = 1 To i_leng Step 3
      ...
      Next
      'YQasp.Console s2 & " == " & s_re & " -- " & s2n(s_re, 50, 39)
    ...
    For i = 1 To i_times
      For j = 1 To i_keyleng
        ...
        i_str = a_re(i_pos)
        i_re = i_str - i_key - 60000
        'YQasp.Console Mid(s_enkey, j, 1) & " - "  & i_pos
        'YQasp.Console i_re & " = " & i_str & " - " & i_key & " - 42769"
        'YQasp.Println i_re
        SB.Append ChrW(i_re)
        i_pos = i_pos + 1
